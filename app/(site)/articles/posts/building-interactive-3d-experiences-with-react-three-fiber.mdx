...
I've also included a basic interactive scene. Use the tabs below to switch between the Fishbowl and the Interactive Shapes example. In the interactive example, you can click on a shape to increase its size.
...
<SceneExplorer sceneNames={['Fishbowl', 'Interactive Shapes']}>
  <FishbowlScene />
  <ThreeScene />
</SceneExplorer>
