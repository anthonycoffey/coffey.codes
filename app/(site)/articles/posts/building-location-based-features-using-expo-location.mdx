---
title: 'Expo Location Guide: Permissions, GPS, and Geofencing'
publishedAt: '2025-03-24'
updated: '2026-05-22'
summary: 'Copy-paste-ready expo-location patterns for React Native: requesting permissions, reading GPS coordinates, watching position, and setting up geofencing.'
...
## getCurrentPositionAsync: Reading the Current Position
...
## requestForegroundPermissionsAsync and requestBackgroundPermissionsAsync
...
## watchPositionAsync: Subscribing to Position Updates
...
## reverseGeocodeAsync: Coordinates to Addresses
...
## startGeofencingAsync and TaskManager
...
Full API reference: [Expo Location documentation](https://docs.expo.dev/versions/latest/sdk/location/).

<Callout type="warning">
  Location data is sensitive. Be explicit with users about what gets collected,
