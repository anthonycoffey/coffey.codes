...
<Callout type="warning">
  Remember that with location data comes responsibility - always be transparent
  with your users about how their location information is being used and stored!
</Callout>
