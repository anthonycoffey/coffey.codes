---
title: 'React 19 Features: Actions API, Server Components, Compiler'
publishedAt: 2025-03-17
updated: 2026-05-22
summary: 'What changes in React 19: the Actions API, Document Metadata, enhanced Server Components, and the React Compiler — with code examples and design-pattern notes.'
