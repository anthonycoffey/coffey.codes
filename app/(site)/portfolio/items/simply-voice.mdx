...
images: [/portfolio/tts-created.jpg, /portfolio/tts-history.jpg]
...
flowchart LR
  ...
  SPA -.->|sign in| SBA[(Supabase Auth)]
  SPA -->|text payload| CF[Cloud Function<br/>Node.js · service account]
  CF -->|synthesize| TTS[[Google Cloud<br/>Text-to-Speech]]
  TTS -->|.wav buffer| CF
  CF -->|upload to user namespace| SB[(Supabase Storage)]
  SPA -->|signed URL · download| SB
```
