...
Having an MDX powered blog is frickin' wild y'all! I can import React components directly into my article! 😲
...
Check out the code for this website [here](https://github.com/anthonycoffey/coffey.codes)
...
Now I have an easy way to quickly write articles with code snippets and images. I can even import components directly into my article!
...
<div className="grid grid-cols-2 prose lg:prose-xl">
  <blockquote className="lg:text-2xl lg:mt-10 pr-4">
    "Ay ton', you heard what I said? ... I said I can import components directly
    into my article.. heh heh"
  </blockquote>
  <div>
    <Image src={paulie} alt="Paulie Walnuts" width={300} height={300} />
  </div>
</div>
