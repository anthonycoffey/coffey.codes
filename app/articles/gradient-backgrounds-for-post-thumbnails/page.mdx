...
To do this, all you have to do is create a file `generateRandomGradient.js` and move the `generateRandomGradient` function into it and export it. Then, you can import it wherever you need it in your application.
