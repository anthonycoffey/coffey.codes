---
title: Avoiding Unnecessary Re-Renders in React Applications
...
- The function is simple and doesn't render frequently
...
However, in React v19, the React team has implemented an "automatic memoization" feature which intelligently handles function references and derived values behind the scenes, making this less of a concern.
...
Use `useMemo` to cache calculations between renders:
