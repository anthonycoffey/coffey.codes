...
summary: 'Learn how to create captivating 3D experiences on the web by combining the power of Three.js with React using React Three Fiber - a declarative way to build 3D scenes in your React applications.'
tags: React, Three.js, React Three Fiber, 3D Graphics, WebGL, Interactive Web
category: Web Development
---

> **Note:** This article demonstrates how to integrate Three.js with React using React Three Fiber, showing how to create interactive 3D experiences for your web applications.
...
Below are some interactive examples that demonstrate React Three Fiber in action. Feel free to interact with them!

### Basic Shapes Example

This example shows two simple 3D shapes that rotate continuously. Click on a shape to increase its size.

<ThreeScene />

### Interactive Model with Controls

This interactive torus allows you to adjust its rotation speed using the slider:
