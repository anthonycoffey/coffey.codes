...
summary: 'Sometimes you need to kill a process by port number. This is how you do it.'
tags: CLI, Terminal, Port Management, Node.js, Troubleshooting, Process Management
...
You might've seen an error like Error: listen EADDRINUSE: address already in use :::5000 and wondered what to do next.

If so, I have an easy solution for you! There is an incredibly useful Node.js package called `kill-port` that allows you to kill a process on a given port.
...
<Image
  src={'/npx-kill-port.png'}
  width={480}
  height={55}
  alt="npx kill port success"
  className="mx-auto w-full p-2"
/>


### What if kill-port doesn't work? 🤔
...
### ...and if I want to see which process is running on that port before terminating it? 😟
