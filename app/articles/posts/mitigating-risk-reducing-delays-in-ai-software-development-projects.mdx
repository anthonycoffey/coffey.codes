...
AI projects often falter due to poor data management. AI models rely heavily on high-quality data to function effectively, and inadequate attention to data preparation can cause significant delays.
...
Scope creep, where project requirements expand beyond the original plan, is a common issue in software development. Scope creep can significantly extend project timelines as new features are added without sufficient planning or resources.
...
A lack of strong project leadership is a significant reason why many software projects falter. Effective project managers not only ensure that teams adhere to timelines but also proactively address risks before they escalate.
...
Operationalizing AI models, moving them from development into a live environment, often proves to be a bottleneck. Many AI projects remain in the proof-of-concept stage because of difficulties in deploying and scaling them. Addressing infrastructure and deployment early in the project lifecycle can prevent these delays.
...
<a name="2">[2]</a> [Delivering large-scale IT projects
                     on time, on budget, and on value](https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/delivering-large-scale-it-projects-on-time-on-budget-and-on-value)
