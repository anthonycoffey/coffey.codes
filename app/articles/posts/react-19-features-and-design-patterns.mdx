...
- [Official React Actions API Documentation](https://react.dev/reference/react/useAction)
- [Actions API Deep Dive Tutorial](https://react.dev/learn/actions-in-depth)
- [GitHub RFC Discussion: Actions API](https://github.com/reactjs/rfcs/discussions/229)
...
- [React Document Metadata API Documentation](https://react.dev/reference/react/useDocumentHead)
- [Managing SEO with Document Metadata API](https://react.dev/learn/document-metadata-patterns)
- [Migration Guide from React Helmet](https://react.dev/learn/metadata-migration-guide)
...
- [Enhanced Server Components Documentation](https://react.dev/reference/react/server-components)
- [Server Component Data Fetching Patterns](https://react.dev/learn/server-component-patterns)
- [React Server Component Fundamentals](https://react.dev/learn/use-server)
- [Advanced Caching Strategies for Server Components](https://react.dev/learn/caching-in-server-components)
...
- [Partial Hydration Documentation](https://react.dev/reference/react/hydration)
- [Conditional Hydration Strategies](https://react.dev/learn/conditional-hydration)
- [Performance Benefits of Partial Hydration](https://react.dev/blog/2025/03/introducing-partial-hydration)
- [Case Study: E-commerce Site Optimization with Partial Hydration](https://react.dev/case-studies/partial-hydration-ecommerce)
...
- [React Compiler Documentation](https://react.dev/reference/react/compiler)
- [Migration Guide to React Compiler](https://react.dev/learn/react-compiler-migration)
- [React Compiler: Under the Hood](https://react.dev/blog/2025/01/react-compiler-deep-dive)
- [Performance Benchmarks with React Compiler](https://react.dev/blog/2025/02/react-compiler-benchmarks)
- [GitHub Repository: React Compiler](https://github.com/facebook/react/tree/main/packages/react-compiler)
...
- [Streaming Rendering Documentation](https://react.dev/reference/react/streaming)
- [Suspense for Data Fetching Guide](https://react.dev/reference/react/Suspense)
- [Building UIs with Streaming Data](https://react.dev/learn/streaming-data-patterns)
- [Case Study: Streaming Search Experience](https://react.dev/case-studies/streaming-search-implementation)
...
- [Progressive Enhancement Patterns](https://react.dev/learn/progressive-enhancement)
- [Building Resilient React Apps](https://react.dev/blog/2025/01/resilient-react-applications)
- [React without JavaScript](https://react.dev/learn/react-without-javascript)
- [Client Only Component API](https://react.dev/reference/react/ClientOnly)
...
- [Islands Architecture in React](https://react.dev/learn/islands-architecture)
- [ClientIsland API Documentation](https://react.dev/reference/react/ClientIsland)
- [Performance Impact of Islands Architecture](https://react.dev/blog/2025/02/measuring-islands-performance)
- [Case Study: News Website Migration to Islands](https://react.dev/case-studies/islands-news-website)
...
- [Hybrid Rendering Documentation](https://react.dev/reference/react/hybrid-rendering)
- [StaticRSC and DynamicRSC API Reference](https://react.dev/reference/react/rendering-apis)
- [Guide to Mixed Rendering Strategies](https://react.dev/learn/choosing-the-right-rendering-strategy)
- [Performance Optimizations with Hybrid Rendering](https://react.dev/blog/2025/01/hybrid-rendering-deep-dive)
...
- [Resource Loading API Documentation](https://react.dev/reference/react/preload)
- [Predictive Fetching Strategies](https://react.dev/learn/predictive-fetching)
- [Preloading Assets in React 19](https://react.dev/blog/2025/02/effective-preloading-in-react)
- [Optimizing Navigation with Preloading](https://react.dev/learn/optimizing-navigation-experiences)
...
- [Official React 19 Migration Guide](https://react.dev/blog/2025/03/migrating-to-react-19)
- [React 19 Upgrade Helper Tool](https://github.com/reactjs/react-upgrade-helper)
- [Codemod Collection for React 19](https://react.dev/reference/codemods)
- [Breaking Changes in React 19](https://react.dev/reference/react-19-breaking-changes)
- [Incremental Adoption Strategy](https://react.dev/learn/incremental-react-adoption)
...
- [React 19 Performance Optimization Guide](https://react.dev/learn/performance-optimization)
- [Measuring Performance in React 19](https://react.dev/learn/measuring-performance)
- [Case Studies: Performance Improvements with React 19](https://react.dev/case-studies/performance-wins)
- [Advanced Caching Techniques in React 19](https://react.dev/learn/advanced-caching)
- [Performance Profiling Tools for React 19](https://react.dev/reference/react/profiler)
