...
<Callout type="info">
  Pytest will automatically discover and execute all test functions in the file,
...
<Callout type="tip">
  Following these conventions ensures that pytest can efficiently locate and run
  your tests.
</Callout>
...
<Callout type="tip">
  Fixtures can be used to set up database connections, create test data, or
  prepare mock environments before running tests.
</Callout>
...
<Callout type="info">
  This test runs multiple assertions with different input values, improving
  efficiency.
</Callout>
...
<Callout type="tip">
  Mocking allows you to isolate specific parts of your code and simulate
  different scenarios.
</Callout>
