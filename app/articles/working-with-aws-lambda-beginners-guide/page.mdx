export const metadata = {
  ...
  description: `AWS Lambda is a serverless computing service provided by Amazon Web Services that allows developers to run code without provisioning or managing servers.`,
  date: "April 9, 2024",
