...
summary: 'Software development can be complex and time-consuming. Here are some tools that can help you be more productive:'
---

Software development can be complex and time-consuming. Here are some tools that can help you be more productive:

- **Workflow:** Familiarize yourself with keyboard shortcuts for the terminal and the IDEs that you use. For example, the refactoring features available in WebStorm are insane time savers.
...
- **CI/CD tools:** CI/CD tools allow you to automate the process of building and testing your code when changes are made. This can help you catch bugs early and make the development lifecycle a lot less painful. Popular CI tools include Jenkins, Travis CI, and CircleCI.
