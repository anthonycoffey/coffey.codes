...
export default function CaseStudyPdfCta({ pdfPath, title }: Props) {
  return (
    <aside
      data-testid="case-study-pdf-cta"
      className="group not-prose relative mt-16 overflow-hidden rounded-2xl border border-border bg-surface"
    >
      ...
      <div className="grid items-center gap-8 p-6 sm:p-8 md:grid-cols-[auto_1fr] md:gap-10">
        {/* Stacked document visual — animates on card hover */}
        <div
          aria-hidden="true"
        ...
        <div className="text-center md:text-left">
          ...
          <p className="mx-auto mt-3 mb-6 max-w-xl leading-relaxed text-c-muted md:mx-0">
            Download the original case study to read offline or share with your
            team.
          </p>
          <a
            href={pdfPath}
