...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    'bg-accent1-dark text-surface border-2 border-accent1-dark hover:opacity-90',
  secondary:
    'bg-surface text-c-heading border-2 border-border hover:bg-surface-hover',
  ghost:
    'bg-transparent text-c-text border-2 border-border hover:bg-surface-hover',
};
