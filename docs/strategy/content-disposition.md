...
| 4 | [`react-19-features-and-design-patterns`](../../app/(site)/articles/posts/react-19-features-and-design-patterns.mdx) | Web Development | 2025-03-17 | 52 | A | Anchor URLs (`#actions-api`, `#react-compiler`, `#resource-loading-patterns`) rank at positions 6-8 but earn zero clicks. SPEC-030 WS6 (live `seo_cannibalization` 2026-05-22) confirms this as **self-cannibalization** — the parent URL competes with its own anchor fragments for `react 19 new features and patterns` (177 impressions / 0 clicks across 4 URL variants: parent at 48 impr + 3 anchors at 43 impr each). `#streaming-patterns` ranks for the same query at 26 impr per `seo_striking_distance` but didn't cross the cannibalization tool's surfacing threshold. Not canonical-fixable; the TOC + heading anchors are the structural cause. Refresh decision at refresh-time: tighten body, or split into multiple shorter pieces. |
...
| 12 | [`building-interactive-3d-experiences-with-react-three-fiber`](../../app/(site)/articles/posts/building-interactive-3d-experiences-with-react-three-fiber.mdx) | Web Development | 2025-03-29 | (<3) | C | Adjacent to `three-js-portfolio-website-for-software-engineer`. SPEC-030 WS6 (live `seo_cannibalization` 2026-05-22) confirms **no cannibalization between the pair** — coexists cleanly. Internal-link candidate at the RelatedPosts level (now auto-surfaced by the WS3 component); no consolidation needed. |
| 13 | [`building-an-mdx-powered-blog-using-app-router-next-js`](../../app/(site)/articles/posts/building-an-mdx-powered-blog-using-app-router-next-js.mdx) | Web Development | 2024-10-01 | (<3) | C | Adjacent to `step-by-step-building-your-blog-with-next-js-and-mdx`. SPEC-030 WS6 (live `seo_cannibalization` 2026-05-22) confirms **no cannibalization between the pair** — the prior "possible consolidation at next cycle" hypothesis is data-disproved. Both can coexist as-is. |
| 14 | [`step-by-step-building-your-blog-with-next-js-and-mdx`](../../app/(site)/articles/posts/step-by-step-building-your-blog-with-next-js-and-mdx.mdx) | Web Development | 2025-03-25 | (<3) | C | See #13. No consolidation needed. |
...
- 2026-05-23. SPEC-030 WS1 shipped: title/summary/`updated` rewritten on rows 1-4 to fix the CTR gap on high-impression pages. SPEC-030 WS6 (live `seo_cannibalization`, `minImpressions: 30`, 90-day window) refined two table entries: the #13/#14 (mdx-blog) and #12/#20 (three-js) pair-cannibalization hypotheses are disproved (no canonicals needed); the #4 react-19 anchor-fragment ranking is recharacterized as self-cannibalization (TOC-structural, not metadata-fixable, editorial item for next refresh). Internal linking on the C-bucket articles is now auto-surfaced by the `RelatedPosts` component (shared-tags + same-category ranker) at the foot of every article page.
