const colorPairs: string[][] = [
  ...
  ["#DB7093", "#C71585"], // Pale Violet Red to Medium Violet Red
  ...
  ["#BA55D3", "#800080"], // Medium Orchid to Purple
  ["#DDA0DD", "#DA70D6"], // Plum to Orchid
  ["#EE82EE", "#FF00FF"], // Violet to Magenta
  ["#FF00FF", "#FF69B4"], // Magenta to Hot Pink
  ["#FF1493", "#FF4500"], // Deep Pink to Orange Red
  ["#FFA07A", "#FFD700"], // Light Salmon to Gold
  ["#32CD32", "#00BFFF"], // Lime Green to Deep Sky Blue
  ["#BA55D3", "#87CEFA"], // Medium Orchid to Light Sky Blue
